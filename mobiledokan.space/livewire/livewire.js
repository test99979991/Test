...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    var CommitBus = class {
        ...
        createAndSendNewPool() {
            trigger2("commit.pooling", {
                commits: this.commits
            });
            let pools = this.corraleCommitsIntoPools();
            this.commits.clear();
            trigger2("commit.pooled", {
                pools
            });
            pools.forEach((pool) => {
                if (pool.empty())
    ...
    function src_default3(Alpine3) {
        ...
        Alpine3.directive("trap", Alpine3.skipDuringClone((el, {
            expression,
            modifiers
        }, {
            effect: effect3,
    ...
    function src_default4(Alpine3) {
        ...
        Object.defineProperty(Alpine3, "$persist", {
            get: () => persist()
        });
    ...
    function src_default7(Alpine3) {
        ...
        Alpine3.directive("anchor", Alpine3.skipDuringClone((el, {
            expression,
            modifiers,
            value
        }, {
    ...
    on2("effect", ({
        ...
        Object.entries(queryString).forEach(([key, value]) => {
            ...
            if (use === "replace") {
                ...
                let forgetCommitHandler = on2("commit", ({
    ...
    directive2("transition", ({
        ...
        let cleanups2 = [];
        cleanups2.push(on2("morph.removing", ({
            el: el2,
            skip
        }) => {
            skip();
    ...
    function getTargets(el) {
        ...
        if (directives2.has("target")) {
            ...
            directives2.all().filter((i) => !nonActionOrModelLivewireDirectives.includes(i.value)).map((i) => i.expression.split("(")[0]).forEach((target) => targets.push({
                target
            }));
        }
        return {
